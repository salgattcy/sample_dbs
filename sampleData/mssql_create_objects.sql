...
CREATE TABLE sales.customers_private (
        private_data_id INT IDENTITY (1, 1) PRIMARY KEY,
        customer_id INT,
...
CREATE TABLE sales.orders_client_ipv4_info (
        private_data_id INT IDENTITY (1, 1) PRIMARY KEY,
        order_id INT,
...
CREATE TABLE sales.orders_client_ipv6_info (
        private_data_id INT IDENTITY (1, 1) PRIMARY KEY,
        order_id INT,
        ip_address VARCHAR (50) NOT NULL UNIQUE,
        FOREIGN KEY (order_id) REFERENCES sales.orders (order_id) ON DELETE CASCADE ON UPDATE CASCADE
